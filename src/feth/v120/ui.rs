...
pub fn display_text(pos_x: f32, pos_y: f32, scale_x: f32, scale_y: f32, text: *const c_char, box_clipping: u32, unk1: u32, centered: bool, unk2: i32, unk3: i32, shading_effect: u8, alpha: i8);
